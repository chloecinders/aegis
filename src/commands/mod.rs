...
impl CommandSyntax {
    ...
    pub fn get_example(&self) -> String {
        match self {
            ...
            CommandSyntax::Filters => String::from("+user @aegis"),
...
pub trait Command: Send + Sync {
    ...
    /// This function should also have the `#[command]` aegis macro attached
    ...
    /// This is normally generated by the `#[command]` aegis macro but can be left out if there are no arguments to define
